//source code from  https://github.com/tarequeh/DES
...
desInt key_shift_sizes[] = {0, 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};//перший елемент не використовується
...
//============================================================================
QByteArray CifrDesCryptoPP::decrypt(QByteArray inData, QByteArray key)
{
    // Generate DES key set
    key_set* key_sets = (key_set*)malloc(17*sizeof(key_set));
...
//============================================================================
void CifrDesCryptoPP::generate_sub_keys(DesList main_key, CifrDesCryptoPP::key_set *key_sets)
{
    int i, j;
    desInt shift_size;
...
//============================================================================
DesList CifrDesCryptoPP::pieceOfData(const QByteArray &inData, const int &offset, const int &inDataLen)
{
    DesList l;
...
//============================================================================
QByteArray CifrDesCryptoPP::process_message(DesList message_piece, CifrDesCryptoPP::key_set *key_sets, int mode)
{
    QByteArray retArr("");
    int i, k;
    desInt shift_size;
