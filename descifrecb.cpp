...
//======================================================================
DEScifrECB::DEScifrECB(QObject *parent) : QObject(parent)
{
//    Des d1,d2;
...
//======================================================================
void DEScifrECB::xor_oneE(int round)
{
    int i;
    for(i=0; i<48; i++)
...
//======================================================================
void DEScifrECB::xor_oneD(int round)
{
    int i;
    for(i=0; i<48; i++)
...
//======================================================================
QByteArray DEScifrECB::desEncrypt(QByteArray inData, QByteArray arrKey)
{
    int i,a1,j,nB,m,iB,k,K,B[8],n,d,round;
    char *Text=new char[1000];
    strcpy(Text,inData.data());
    ...
    keygen(arrKey);
    QByteArray arr;
    for(iB=0,nB=0,m=0; m<(int)(strlen(Text)/8); m++) //Repeat for TextLenth/8 times.
    {
        ...
        for(i=0; i<8; i++)
        {
            ...
            arr.append((quint8)d);
//            qDebug() << mc << (int)final[mc - 1] << d << (quint8)d;
            k=128;
            d=0;
        }
    } //for loop ends here
...
//======================================================================
QByteArray DEScifrECB::desDecrypt(QByteArray inData, QByteArray arrKey)
{
...
//======================================================================
QBitArray DEScifrECB::byteArrayToBitArray(const QByteArray &byteArr)
{
    int iMax = byteArr.size();
